    ...
    >
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="relative flex flex-col md:flex-row gap-6 md:gap-0 justify-center items-center md:items-start">
          {/* Others card */}
          <div className="card-others w-full md:w-[420px] bg-[#1a1a1a] rounded-2xl p-8 md:translate-y-4 shadow-2xl z-10">
          ...
          {/* Harbi card */}
          <div className="card-harbi w-full md:w-[420px] bg-[#111111] rounded-2xl p-8 md:-translate-x-4 shadow-2xl z-20 border border-[#a3e635]/20">
            <div className="flex items-center gap-3 mb-8">
